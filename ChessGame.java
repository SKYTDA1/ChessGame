package chessgame;
 ...
 public class ChessGame {
     ...
     public static void main(String[] args) throws IOException {
         ...
         Piece wrook=new Piece(0,6,true,"rook",ps);
         Piece wkinght=new Piece(1,6,true,"kinght",ps);
         Piece wbishop=new Piece(2,6,true,"bishop",ps);
         Piece wqueen=new Piece(3,6,true,"queen",ps);
         Piece wking=new Piece(4,6,true,"king",ps);
         Piece wbishop2=new Piece(5,6,true,"bishop",ps);
         Piece wkinght2=new Piece(6,6,true,"kinght",ps);
         Piece wrook2=new Piece(7,6,true,"rook",ps);
         Piece wpawn1=new Piece(1,7,true,"pawn",ps);
         Piece wpawn2=new Piece(2,7,true,"pawn",ps);
         Piece wpawn3=new Piece(3,7,true,"pawn",ps);
         Piece wpawn4=new Piece(4,7,true,"pawn",ps);
         Piece wpawn5=new Piece(5,7,true,"pawn",ps);
         Piece wpawn6=new Piece(6,7,true,"pawn",ps);
         Piece wpawn7=new Piece(7,7,true,"pawn",ps);
         Piece wpawn8=new Piece(0,7,true,"pawn",ps);
